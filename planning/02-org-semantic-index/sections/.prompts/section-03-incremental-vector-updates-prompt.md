...
Generate content for section `section-03-incremental-vector-updates` (filename: `section-03-incremental-vector-updates.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `/Users/yashpalc/yashpalc-mcp/mcp-repo-context/planning/02-org-semantic-index/claude-plan.md` - Full implementation plan
2. `/Users/yashpalc/yashpalc-mcp/mcp-repo-context/planning/02-org-semantic-index/claude-plan-tdd.md` - Test stubs for each section
3. `/Users/yashpalc/yashpalc-mcp/mcp-repo-context/planning/02-org-semantic-index/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-03-incremental-vector-updates` to understand what this section should contain.
...
`/Users/yashpalc/yashpalc-mcp/mcp-repo-context/planning/02-org-semantic-index/sections/section-03-incremental-vector-updates.md`
