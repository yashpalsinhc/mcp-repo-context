...
Generate content for section `section-04-stale-cleanup` (filename: `section-04-stale-cleanup.md`).
...
for `section-04-stale-cleanup` to understand what this section should contain.
...
`/Users/yashpalc/yashpalc-mcp/mcp-repo-context/planning/02-org-semantic-index/sections/section-04-stale-cleanup.md`
