...
Generate content for section `section-07-integration-tests` (filename: `section-07-integration-tests.md`).
...
for `section-07-integration-tests` to understand what this section should contain.
...
`/Users/yashpalc/yashpalc-mcp/mcp-repo-context/planning/02-org-semantic-index/sections/section-07-integration-tests.md`
