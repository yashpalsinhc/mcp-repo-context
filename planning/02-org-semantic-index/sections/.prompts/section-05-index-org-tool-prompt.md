...
Generate content for section `section-05-index-org-tool` (filename: `section-05-index-org-tool.md`).
...
for `section-05-index-org-tool` to understand what this section should contain.
...
`/Users/yashpalc/yashpalc-mcp/mcp-repo-context/planning/02-org-semantic-index/sections/section-05-index-org-tool.md`
