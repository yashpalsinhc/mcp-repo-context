...
Generate content for section `section-06-extend-index-repository` (filename: `section-06-extend-index-repository.md`).
...
for `section-06-extend-index-repository` to understand what this section should contain.
...
`/Users/yashpalc/yashpalc-mcp/mcp-repo-context/planning/02-org-semantic-index/sections/section-06-extend-index-repository.md`
