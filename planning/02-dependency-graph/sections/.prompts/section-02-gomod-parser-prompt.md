...
Generate content for section `section-02-gomod-parser` (filename: `section-02-gomod-parser.md`).
...
for `section-02-gomod-parser` to understand what this section should contain.
...
`/Users/yashpalc/yashpalc-mcp/mcp-repo-context/planning/02-dependency-graph/sections/section-02-gomod-parser.md`
