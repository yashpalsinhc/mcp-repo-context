...
Generate content for section `section-03-config-parsers` (filename: `section-03-config-parsers.md`).
...
for `section-03-config-parsers` to understand what this section should contain.
