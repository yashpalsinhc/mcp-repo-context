...
Generate content for section `section-06-dependency-graph-tool` (filename: `section-06-dependency-graph-tool.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `/Users/yashpalc/yashpalc-mcp/mcp-repo-context/planning/02-dependency-graph/claude-plan.md` - Full implementation plan
2. `/Users/yashpalc/yashpalc-mcp/mcp-repo-context/planning/02-dependency-graph/claude-plan-tdd.md` - Test stubs for each section
3. `/Users/yashpalc/yashpalc-mcp/mcp-repo-context/planning/02-dependency-graph/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-06-dependency-graph-tool` to understand what this section should contain.
...
`/Users/yashpalc/yashpalc-mcp/mcp-repo-context/planning/02-dependency-graph/sections/section-06-dependency-graph-tool.md`
