...
Generate content for section `section-08-integration-test` (filename: `section-08-integration-test.md`).
...
for `section-08-integration-test` to understand what this section should contain.
...
`/Users/yashpalc/yashpalc-mcp/mcp-repo-context/planning/02-dependency-graph/sections/section-08-integration-test.md`
