...
Generate content for section `section-02-config-inheritance` (filename: `section-02-config-inheritance.md`).
...
for `section-02-config-inheritance` to understand what this section should contain.
...
`/Users/yashpalc/yashpalc-mcp/mcp-repo-context/planning/01-org-abstraction/sections/section-02-config-inheritance.md`
