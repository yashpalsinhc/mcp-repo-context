...
Generate content for section `section-04-analyzer` (filename: `section-04-analyzer.md`).
...
for `section-04-analyzer` to understand what this section should contain.
...
`/Users/yashpalc/yashpalc-mcp/mcp-repo-context/planning/01-org-abstraction/sections/section-04-analyzer.md`
