...
Generate content for section `section-03-store-interface-sqlite` (filename: `section-03-store-interface-sqlite.md`).
...
for `section-03-store-interface-sqlite` to understand what this section should contain.
...
`/Users/yashpalc/yashpalc-mcp/mcp-repo-context/planning/01-org-abstraction/sections/section-03-store-interface-sqlite.md`
