...
Generate content for section `section-05-filesystem-migration` (filename: `section-05-filesystem-migration.md`).
...
for `section-05-filesystem-migration` to understand what this section should contain.
...
`/Users/yashpalc/yashpalc-mcp/mcp-repo-context/planning/01-org-abstraction/sections/section-05-filesystem-migration.md`
