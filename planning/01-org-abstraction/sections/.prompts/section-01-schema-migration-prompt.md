...
Generate content for section `section-01-schema-migration` (filename: `section-01-schema-migration.md`).
...
for `section-01-schema-migration` to understand what this section should contain.
...
`/Users/yashpalc/yashpalc-mcp/mcp-repo-context/planning/01-org-abstraction/sections/section-01-schema-migration.md`
