...
Generate content for section `section-06-mcp-tools-wiring` (filename: `section-06-mcp-tools-wiring.md`).
...
for `section-06-mcp-tools-wiring` to understand what this section should contain.
...
`/Users/yashpalc/yashpalc-mcp/mcp-repo-context/planning/01-org-abstraction/sections/section-06-mcp-tools-wiring.md`
