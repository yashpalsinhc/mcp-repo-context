...
Generate content for section `section-07-integration-tests-benchmarks` (filename: `section-07-integration-tests-benchmarks.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `/Users/yashpalc/yashpalc-mcp/mcp-repo-context/planning/01-org-abstraction/claude-plan.md` - Full implementation plan
2. `/Users/yashpalc/yashpalc-mcp/mcp-repo-context/planning/01-org-abstraction/claude-plan-tdd.md` - Test stubs for each section
3. `/Users/yashpalc/yashpalc-mcp/mcp-repo-context/planning/01-org-abstraction/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-07-integration-tests-benchmarks` to understand what this section should contain.
...
`/Users/yashpalc/yashpalc-mcp/mcp-repo-context/planning/01-org-abstraction/sections/section-07-integration-tests-benchmarks.md`
