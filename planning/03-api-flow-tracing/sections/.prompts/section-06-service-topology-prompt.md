...
Generate content for section `section-06-service-topology` (filename: `section-06-service-topology.md`).
...
for `section-06-service-topology` to understand what this section should contain.
...
`/Users/yashpalc/yashpalc-mcp/mcp-repo-context/planning/03-api-flow-tracing/sections/section-06-service-topology.md`
