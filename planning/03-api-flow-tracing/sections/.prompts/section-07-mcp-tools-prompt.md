...
Generate content for section `section-07-mcp-tools` (filename: `section-07-mcp-tools.md`).
...
for `section-07-mcp-tools` to understand what this section should contain.
...
`/Users/yashpalc/yashpalc-mcp/mcp-repo-context/planning/03-api-flow-tracing/sections/section-07-mcp-tools.md`
