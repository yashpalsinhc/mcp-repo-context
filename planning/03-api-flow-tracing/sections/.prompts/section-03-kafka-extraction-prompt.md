...
Generate content for section `section-03-kafka-extraction` (filename: `section-03-kafka-extraction.md`).
...
for `section-03-kafka-extraction` to understand what this section should contain.
...
`/Users/yashpalc/yashpalc-mcp/mcp-repo-context/planning/03-api-flow-tracing/sections/section-03-kafka-extraction.md`
