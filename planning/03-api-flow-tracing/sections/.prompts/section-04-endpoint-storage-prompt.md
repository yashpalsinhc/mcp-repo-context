...
Generate content for section `section-04-endpoint-storage` (filename: `section-04-endpoint-storage.md`).
...
for `section-04-endpoint-storage` to understand what this section should contain.
...
`/Users/yashpalc/yashpalc-mcp/mcp-repo-context/planning/03-api-flow-tracing/sections/section-04-endpoint-storage.md`
