...
Generate content for section `section-02-route-detection` (filename: `section-02-route-detection.md`).
...
for `section-02-route-detection` to understand what this section should contain.
...
`/Users/yashpalc/yashpalc-mcp/mcp-repo-context/planning/03-api-flow-tracing/sections/section-02-route-detection.md`
