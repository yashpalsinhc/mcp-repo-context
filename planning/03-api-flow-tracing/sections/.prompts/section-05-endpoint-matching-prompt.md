...
Generate content for section `section-05-endpoint-matching` (filename: `section-05-endpoint-matching.md`).
...
for `section-05-endpoint-matching` to understand what this section should contain.
...
`/Users/yashpalc/yashpalc-mcp/mcp-repo-context/planning/03-api-flow-tracing/sections/section-05-endpoint-matching.md`
